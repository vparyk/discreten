    ...
    <Container className="container mx-auto px-4 py-8 flex flex-col gap-8">
      <p>
        ...
        <strong className="font-semibold">
          ingyenes előzetes konzultációval
        </strong>{" "}
        kezdődik, amelynek célja annak közös felmérése, hogy kialakítható-e a
        hatékony együttműködés. Ebben a szakaszban mindkét fél számára adott a
